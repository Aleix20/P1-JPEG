def RGBtoYUV(r, g, b):
    # We apply the formula that we have in the slides#We apply the formula that we have in the slides
...
#Function YUV to RGB conversion
def YUVtoRGB(y, u, v):
    #We apply the formula that we have in the slides
